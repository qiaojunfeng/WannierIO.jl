@testitem "read tb WS" begin
    ...
    @test size(tbdat.r_x, 3) == size(tbdat.r_y, 3) == size(tbdat.r_z, 3) == 279
    r_x1 = ComplexF64[
...
@testitem "read tb MDRS" begin
    ...
    tbdat_ws = read_w90_tb_dat(artifact"Si2_valence/outputs/WS/Si2_valence_tb.dat")
